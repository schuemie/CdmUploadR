...
-   Creates all tables, contraints, and indices.
...
This repo currently contains SQL for CDM 5.4.0. This can be updated by replacing the SQL files with newer ones from <https://github.com/OHDSI/CommonDataModel>
